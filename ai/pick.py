...
def main():
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        prompt = (
            ...
            "The passage MUST begin and end at natural SENTENCE boundaries — never start "
            "or end mid-sentence. Set `dur` so it ends a beat AFTER the final sentence "
            "completes (include ~1 second of the natural pause after the last word), so "
            "the speech is never cut off abruptly.\n\n"
